% function [FDL,D]=FDL_function(Infile,name)
...
vRange = [2:9];		%list of v indices of the images to load from the files.
crop = [1 1 1 1];		%croped pixels form the input images [left,right,top,bottom].
padType = 'replicate';	%'replicate' or 'symmetric'
...
% LF=zm_loadLF(Infile,name,uRange,vRange,crop);
